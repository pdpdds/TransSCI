...
#define INTERFACE_V56PROPSTR "%20cInformazioni Generali%20c\n\nCelle: %d\n%sCompresso\nRisoluzione: %s\nDimensione Celle: %d\n\n\n%20cCella Selezionata %d%20c\n\nDimensioni: %d x %d\nPosizione: %d,%d\nColore Trasparente: %d\nCompressione: %d\nAttributi: %X\nPriorità asse Z: %d\nxyPos: %d,%d\n"
#define INTERFACE_NOTSTR "Non "
#define INTERFACE_SEEVIEWRESSTR " (vedi Risoluzione View)"
#define INTERFACE_PROPVIEWSTR "%20cInformazioni Generali%20c\n\nCicli: %d\n%sCompresso\nRisoluzione View: %s\nCelle Complessive: %d\nDimensione Cicli: %d\nDimensione Celle: %d\nRisoluzione: %s\n\n\n%20cCiclo Selezionato %d%20c\n\nCelle: %d\nBasato sul Ciclo: %d\n%sCapovolto\n"
...
#define INTERFACE_UPDATES "Aggiornamenti su http://erolfi.wordpress.com\n\nPer problemi, suggerimenti o altro scrivimi a: \n erolfi@gmail.com\n"
