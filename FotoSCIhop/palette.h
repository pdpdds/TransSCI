...
public:
	...
	{ for (int i = 0; i<256; i++)
	  {
          ...
          _palData[i].red = 0;	//255 qui e 0 al green per il violetto
		  _palData[i].remap = 0;
	  }
    /*  _palData[255].blue = 0;// 255;
	  _palData[255].green = 255;
	  _palData[255].red =255;// qui e 0 al green per il violetto
	...
	//void SetUnkShit(char unkb1[11], char *unkb2[10], short unks, long unkl)
	//{ _unkBytes1=unkb1; _unkBytes2=unkb2; _unkShort=unks; _unkLong=unkl; }

	//TODO getunkshit separati, per ora non ci serve avendo usato WritePalette
